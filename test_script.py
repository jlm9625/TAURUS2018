...
clean_dfile = tau.clean_gaia_data(data,'dummy.csv',noclean=True)
print(clean_dfile)
...
modfile = 'isochrones/baraffe_2015_solar_gaia_stacked.pkl'
#sample_2d = tau.sample_generate_2d(nsamples=100000,regen=True,use_mini=True,outfilename = 'isochrones/BHAC15_mini.pkl',modelfile=modfile,agelims=[1.0,3000.0],masslims=[0.1,1.39])
##try loading it instead of regening
sample_2d = tau.sample_generate_2d(nsamples=100000,regen=False,outfilename = None,readfile='isochrones/BHAC15_mini.pkl',modelfile=None,agelims=[1.0,3000.0],masslims=[0.1,1.0])
